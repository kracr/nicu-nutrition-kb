...
import { DischargeTempObj } from '../discharge-print/dischargetempObj';
import { DischargedSummaryData } from '../discharge-print/dischargedSummaryData';
import { Router } from '@angular/router';
import * as $ from 'jquery';
@Component({
  selector: 'app-case-summary-print',
  templateUrl: './case-summary-print.component.html',
  styleUrls: ['./case-summary-print.component.css']
})
export class CaseSummaryPrintComponent implements OnInit {
	  apiData : APIurl;
  	http: Http;
