 ...
 */
@Entity
@Table(name="device_monitor_detail")
@NamedQuery(name="DeviceMonitorDetail.findAll", query="SELECT d FROM DeviceMonitorDetail d")
public class DeviceMonitorDetail implements Serializable {
	...
	@Transient
	private String actualCreationTimeTime;
	...
	public String getActualCreationTimeTime() {
		return actualCreationTimeTime;
	}

	public void setActualCreationTimeTime(String actualCreationTimeTime) {
		this.actualCreationTimeTime = actualCreationTimeTime;
	}
