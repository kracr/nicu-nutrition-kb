...
*
*
*Purpose: adding required columns in NeuromuscularDisorders assessment 

*@Updated on: June 29 2019
*@author: Shweta Nichani Mohanani
*/
@Entity
@Table(name = "sa_cns_neuromuscular_disorder")
@NamedQuery(name = "SaCnsNeuromuscularDisorders.findAll", query = "SELECT s FROM SaCnsNeuromuscularDisorders s")
public class SaCnsNeuromuscularDisorders implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "sa_neuromuscular_disorderid")
    private Long SaCnsNeuromuscularDisordersid;
    ...
    @Column(name = "causeof_neuromuscularDisorder")
    private String causeofNeuromuscularDisorder;

    @Column(name = "causeofneuromuscularDisorder_other")
    private String causeofNeuromuscularDisorderOther;
    ...
    public SaCnsNeuromuscularDisorders() {
        super();
    ...
    public String getCauseofNeuromuscularDisorder() {
        return causeofNeuromuscularDisorder;
    }

    public void setCauseofNeuromuscularDisorder(String causeofNeuromuscularDisorder) {
        this.causeofNeuromuscularDisorder = causeofNeuromuscularDisorder;
    }

    public String getCauseofNeuromuscularDisorderOther() {
        return causeofNeuromuscularDisorderOther;
    }

    public void setCauseofNeuromuscularDisorderOther(String causeofNeuromuscularDisorderOther) {
        this.causeofNeuromuscularDisorderOther = causeofNeuromuscularDisorderOther;
    }
    ...
    public Long getSaCnsNeuromuscularDisordersid() {
        return SaCnsNeuromuscularDisordersid;
    }

    public void setSaCnsNeuromuscularDisordersid(Long SaCnsNeuromuscularDisordersid) {
        SaCnsNeuromuscularDisordersid = SaCnsNeuromuscularDisordersid;
    }
