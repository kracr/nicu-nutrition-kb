 ...
 */
@Entity
@Table(name = "device_incubator_warmer_detail")
@NamedQuery(name = "DeviceIncubatorWarmerDetail.findAll", query = "SELECT d FROM DeviceIncubatorWarmerDetail d")
public class DeviceIncubatorWarmerDetail implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	private Long deviceincubatorid;
	...
	public Long getDeviceincubatorid() {
		return deviceincubatorid;
	}
	...
	public void setDeviceincubatorid(Long deviceincubatorid) {
		this.deviceincubatorid = deviceincubatorid;
	}
