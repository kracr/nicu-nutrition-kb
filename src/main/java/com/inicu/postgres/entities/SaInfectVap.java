...
@Entity
@Table(name = "sa_infection_vap")
@NamedQuery(name = "SaInfectVap.findAll", query = "SELECT s FROM SaInfectVap s")
public class SaInfectVap implements Serializable{
	...
	@Column(columnDefinition = "bool")
	private Boolean isvapavailable;
	...
	public Long getSavapid() {
		return savapid;
	}

	public void setSavapid(Long savapid) {
		this.savapid = savapid;
	}
	...
	public Boolean getIsvapavailable() {
		return isvapavailable;
	}

	public void setIsvapavailable(Boolean isvapavailable) {
		this.isvapavailable = isvapavailable;
	}
