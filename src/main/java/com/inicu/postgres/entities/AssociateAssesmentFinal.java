...
@NamedQuery(name="AssociateAssesmentFinal.findAll", query="SELECT a FROM AssociateAssesmentFinal a")
public class AssociateAssesmentFinal implements Serializable {
	...
	public AssociateAssesmentFinal() {
	}
