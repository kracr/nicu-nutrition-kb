...
@Entity
@Table(name = "sa_cns_hydrocephalus")
@NamedQuery(name = "SaCnsHydrocephalus.findAll", query = "SELECT s FROM SaCnsHydrocephalus s")
public class SaCnsHydrocephalus implements Serializable {

    private static final long serialVersionUID = 1L;

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    private Long sacnshydrocephalusid;
    ...
    @Column(name = "causeof_hydrocephalus")
    private String causeofHydrocephalus;

    @Column(name = "causeofhydrocephalus_other")
    private String causeofHydrocephalusOther;
    ...
    public String getCauseofHydrocephalus() {
        return causeofHydrocephalus;
    }

    public void setCauseofHydrocephalus(String causeofHydrocephalus) {
        this.causeofHydrocephalus = causeofHydrocephalus;
    }

    public String getCauseofHydrocephalusOther() {
        return causeofHydrocephalusOther;
    }

    public void setCauseofHydrocephalusOther(String causeofHydrocephalusOther) {
        this.causeofHydrocephalusOther = causeofHydrocephalusOther;
    }
    ...
    public Long getSacnshydrocephalusid() {
        return sacnshydrocephalusid;
    }

    public void setSacnshydrocephalusid(Long sacnshydrocephalusid) {
        this.sacnshydrocephalusid = sacnshydrocephalusid;
    }
