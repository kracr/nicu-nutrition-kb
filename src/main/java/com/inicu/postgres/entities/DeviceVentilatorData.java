 ...
 */
@Entity
@Table(name="device_ventilator_detail")
@NamedQuery(name="DeviceVentilatorData.findAll", query="SELECT d FROM DeviceVentilatorData d")
public class DeviceVentilatorData implements Serializable {
	...
	// parameters coming from sle5000
