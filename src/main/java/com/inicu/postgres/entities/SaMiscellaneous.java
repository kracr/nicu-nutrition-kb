...
@Entity
@Table(name = "sa_miscellaneous")
@NamedQuery(name = "SaMiscellaneous.findAll", query = "SELECT s FROM SaMiscellaneous s")
public class SaMiscellaneous implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	private Long sa_miscellaneous_id;
...
//	private String associatedevent;
	...
	public Long getSamiscellaneousid() {
		return sa_miscellaneous_id;
	}

	public void setSamiscellaneousid(Long samiscellaneousid) {
		this.sa_miscellaneous_id = samiscellaneousid;
	}
...
//	}
	...
	public Long getSa_miscellaneous_id() {
		return sa_miscellaneous_id;
	}

	public void setSa_miscellaneous_id(Long sa_miscellaneous_id) {
		this.sa_miscellaneous_id = sa_miscellaneous_id;
	}
