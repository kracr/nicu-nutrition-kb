...
public class RegressioniNICU{
    ...
    LogNormalTwoParFunction logNormalFunction;
    
    
    public LogNormalTwoParFunction getLogNormalFunction() {
		return logNormalFunction;
	}

	public void setLogNormalFunction(LogNormalTwoParFunction logNormalFunction) {
		this.logNormalFunction = logNormalFunction;
	}

	// Default constructor - primarily facilitating the subclass ImpedSpecRegression
    public RegressioniNICU(){
	}

    // Constructor with data with x as 2D array and weights provided
    public RegressioniNICU(double[][] xData, double[] yData, double[] weight){
    ...
    public RegressioniNICU(double[][] xxData, double[][] yyData, double[][] wWeight){
        this.multipleY = true;
    ...
    public RegressioniNICU(double[] xxData, double[] yData, double[] weight){
        this.nData0 = yData.length;
        int n = xxData.length;
        int m = weight.length;
    ...
    public RegressioniNICU(double[][] xData, double[] yData){
        this.nData0 = yData.length;
        int n = yData.length;
    ...
    public RegressioniNICU(double[][] xxData, double[][] yyData){
        this.multipleY = true;
        int nY1 = yyData.length;
        this.nYarrays = nY1;
        int nY2 = yyData[0].length;
    ...
    public RegressioniNICU(double[] xxData, double[] yData){
        this.nData0 = yData.length;
        int n = xxData.length;
        double[][] xData = new double[1][n];
        double[] weight = new double[n];
    ...
    public RegressioniNICU(double[] xxData, double binWidth, double binZero){
        double[][] data = RegressioniNICU.histogramBins(Conv.copy(xxData), binWidth, binZero);
        int n = data[0].length;
        this.nData0 = n;
        double[][] xData = new double[1][n];
	...
	// Constructor with data as a single array that has to be binned
	// bin width provided
    public RegressioniNICU(double[] xxData, double binWidth){
        double[][] data = RegressioniNICU.histogramBins(Conv.copy(xxData), binWidth);
        int n = data[0].length;
        this.nData0 = n;
        double[][] xData = new double[1][n];
        double[] yData = new double[n];
    ...
    public void enterData(double[] xxData, double binWidth, double binZero){
        double[][] data = RegressioniNICU.histogramBins(xxData, binWidth, binZero);
        int n = data[0].length;
        this.nData0 = n;
        double[][] xData = new double[1][n];
        double[] yData = new double[n];
    ...
    public void enterData(double[] xxData, double binWidth){
        double[][] data = RegressioniNICU.histogramBins(xxData, binWidth);
        int n = data[0].length;
        this.nData0 = n;
        double[][] xData = new double[1][n];
        double[] yData = new double[n];
    ...
    public ArrayList<Object> polynomialBest(int flag){
        ...
        RegressioniNICU reg = new RegressioniNICU(xData[0], yData);
        reg.constant();
        ...
        array0 = RegressioniNICU.testOfAdditionalTerms_ArrayList(chiLast, 0, chi, 1, nData);
        ...
        while(test0){
            ...
            reg.polynomial(ii);
            chi = reg.getChiSquare();
            array0 = RegressioniNICU.testOfAdditionalTerms_ArrayList(chiLast, ii-1, chi, ii, nData);
    ...
    protected void fitNonIntegerPolynomial(int plotFlag){
        ...
        RegressioniNICU.sort(this.xData[0], this.yData, this.weight);

        // Estimate of parameters
        RegressioniNICU reg = new RegressioniNICU(this.xData[0], this.yData, this.weight);
    ...
    public void plotYY(String title){
        ...
        for(int jj=0; jj<this.nYarrays; jj++){
            ...
            RegressioniNICU yyRegr = new RegressioniNICU(this.yData, this.yCalc, this.weight);
            yyRegr.linear();
	...
	// title provided
    public int plotXY(String title){
        this.graphTitle = title;
        int flag=0;
    ...
    public static Vector<Object> testOfAdditionalTerms(double chiSquareR, int nParametersR, double chiSquareF, int nParametersF, int nPoints){
        ArrayList<Object> res = RegressioniNICU.testOfAdditionalTerms_ArrayList(chiSquareR, nParametersR, chiSquareF, nParametersF, nPoints);
    ...
    public static Vector<Object> testOfAdditionalTerms_Vector(double chiSquareR, int nParametersR, double chiSquareF, int nParametersF, int nPoints){
        return RegressioniNICU.testOfAdditionalTerms(chiSquareR, nParametersR, chiSquareF, nParametersF, nPoints);
    }
	...
	protected void fitPoisson(int plotFlag){
	    ...
	    ArrayList<Object> ret1 = RegressioniNICU.dataSign(yData);
	 	Double tempd = null;
	 	Integer tempi = null;
        ...
        step[0] = 0.1D*start[0];
        if(step[0]==0.0D){
            ArrayList<Object> ret0 = RegressioniNICU.dataSign(xData[0]);
	 	    Double tempdd = null;
	...
	protected void fitGaussian(int plotFlag){
	    ...
	    Double tempd=null;
	    ArrayList<Object> retY = RegressioniNICU.dataSign(yData);
	    ...
	    if(yPeak<0.0D){
	        ...
	        retY = RegressioniNICU.dataSign(yData);
	        yFlag=true;
	    }
	...
	public LogNormalTwoParFunction fitLogNormalTwoPar(int plotFlag){
        if(this.multipleY)throw new IllegalArgumentException("This method cannot handle multiply dimensioned y arrays");
	    this.lastMethod=36;
	    this.userSupplied = false;
	    this.linNonLin = false;
	...
	protected void fitLorentzian(int allTest){
	    ...
	    // Calculate  x value at peak y (estimate of the distribution mode)
	    ArrayList ret1 = RegressioniNICU.dataSign(yData);
	 	Integer tempi = null;
	    tempi = (Integer)ret1.get(5);
	 	int peaki = tempi.intValue();
	    double mean = xData[0][peaki];
        ...
        while(testDistType){
                ...
                switch(opt){
                    case 1: // Gaussian
                            ...
                            RegressioniNICU.regressionDetails(fout, reg);
                            break;
    ...
    protected static void regressionDetails(FileOutput fout, RegressioniNICU reg){
        fout.println();
    ...
    protected void fitFrechetWeibull(int allTest, int typeFlag){
	    ...
	    if(yPeak<0.0D){
	        ...
	        retY = RegressioniNICU.dataSign(this.yData);
	        yPeak = -yPeak;
	        ySignFlag = true;
	    }
	    ...
	    // minimum value of x
	    ArrayList<Object> retX = RegressioniNICU.dataSign(this.xData[0]);
	...
	protected void fitGumbel(int allTest, int typeFlag){
	    ...
	    // check  x data
	    ArrayList<Object> retX = RegressioniNICU.dataSign(xData[0]);
	 	Integer tempi = null;
    ...
    protected void fitsexponentialSimple(int plotFlag){
	    ...
	    RegressioniNICU reglin = new RegressioniNICU(xlin, ylin, wlin);
    ...
    // HISTOGRAM METHODS
        ...
        public static double[][] histogramBins(double[] data, double binWidth, double binZero){
            ...
            for(int i=0; i<nPoints; i++){
                ...
                while(test){
                    if(j==nBins-1){
                        if(data[i]>=binWall[j] && data[i]<=binWall[j+1]*(1.0D + RegressioniNICU.histTol)){
                            binFreq[1][j]+= 1.0D;
                            dataCheck[i]=1;
                            test=false;
                        }
        ...
        public static double[][] histogramBins(double[] data, double binWidth){
            ...
            if(rem>=0){
                ...
                if(Math.abs(rem)/span>RegressioniNICU.histTol){
                    // readjust binWidth
                    boolean testBw = true;
                    double incr = RegressioniNICU.histTol/nBins;
                    int iTest = 0;
                    while(testBw){
                       binWidth += incr;
            ...
            return RegressioniNICU.histogramBins(data, binWidth, binZero);
        }
