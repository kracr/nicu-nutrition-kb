 ...
 * @author Dipin
 */
public class NihonKohdenActiveInitiator  implements Initiator {

	private static final Logger log = LoggerFactory.getLogger(NihonKohdenActiveInitiator.class);
	 ...
	 */
	NihonKohdenActiveInitiator(NihonKohdenActiveConnection conn) throws LLPException {
		this.conn = conn;
	...
	public static void main3(String args[]) {
		...
		try {
			...
			NihonKohdenActiveConnection connection = new NihonKohdenActiveConnection(parser, llp, new Socket(
					host, port));
